                ...
                <div class="formulario">
                    ...
                    if (isset($_POST['enviar'])) {
                        ...
                        if (
                            ...
                            $sql = "INSERT INTO contato (nome,email,celular,assunto,mensagem,data) VALUES ('{$nome}','{$email}','{$celular}','{$assunto}','{$mensagem}','{$data}')";
                    ...
                    ?>
                        ...
                        ?>
                            <p>voce precisa prencher todos os campos Obrigatorios</p>
                            <p><a href="contato.php">voltar para o formulario</a></p>
                    <?php
                        }
                    }
                    ...
                    <form action="contato.php" id="form-contato" method="post" name="contato">
                        <p>
                        ...
                        <p>
                            ...
                            <button type="submit" tabindex="11" id="enviar" name="enviar">Enviar Dados</button>
                        </p>
                    </form>
                </div>
            </article>
